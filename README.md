...
```sh
python3 script/checkout.py --version m122-6843251-1
python3 script/build.py
python3 script/archive.py --version m122-6843251-1
```
...
python3 script/archive.py --version m122-6843251-1 --build-type Debug
```
