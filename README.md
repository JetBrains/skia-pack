...
```sh
python3 script/checkout.py --version m116-c456ea9-1
python3 script/build.py
python3 script/archive.py --version m116-c456ea9-1
```
...
python3 script/archive.py --version m116-c456ea9-1 --build-type Debug
```
